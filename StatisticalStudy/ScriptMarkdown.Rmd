...
library(plotly)
library("permute")
#setwd("C:/Users/kepxu/Desktop/Universidad/Workspace/TFM/StatisticalStudy")
setwd("D:/Jesus/Desktop/Universidad/Workspace/TFM/StatisticalStudy")
dataDirectory <- "data"
...
g<-lineartrendPlotAttr(keyGenData[[1]],paste("Key generation"),"Number of attributes","Time (ms)")
# ggsave("KeyGenVaryAttr.pdf", device = cairo_pdf)
show(g) 
```
...
g<-multilinePlotColumns(summarykeyAggrData,"Key Aggregation","Number of signers","Time (ms)","Attributes")
#ggsave("KeyAggrVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotRows(summarykeyAggrData,"Key Aggregation","Number of attributes","Time (ms)","Signers","NS")
#ggsave("KeyAggrVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotColumns(summarySigningData,"Signing","Number of signers","Time (ms)","Attributes")
# ggsave("SignVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("SignVaryAttrTrend.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotColumns(summaryCombineData,"Signature combination","Number of signers","Time (ms)","Attributes")
# ggsave("CombVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("CombVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotColumns(summaryVerifyData,"Signature verification","Number of signers","Time (ms)","Attributes")
# ggsave("VerifyVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotRows(summaryVerifyData,"Signature verification","Number of attributes","Time (ms)","Signers","NS")
# ggsave("VerifyVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("IssuanceTimesVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("IssuanceTimesVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("ZkProofVaryAttr.pdf", device = cairo_pdf)
show(g)
...
g<-multilinePlotRows(summaryZkProofData,"ZK proof generation","Number of revealed attributes","Time (ms)","Attributes","NoAttr")
# ggsave("ZkProofVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZkProofCompVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZkProofCompVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZkProofComp0Hidden.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZkProofComp1Hidden.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("ZkProofVerfVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotRows(summaryZkVerifyData,"ZK proof verification","Number of revealed attributes","Time (ms)","Attributes","NoAttr")
# ggsave("ZkProofVerfVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
ggsave("ZkProofVerfCompVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZkProofVerfCompVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
NS<-5
numberOfAttributes<-c("NoAttr-02","NoAttr-04","NoAttr-06","NoAttr-08")
...
for(nAttr in numberOfAttributes){
  df[parseToNumber(nAttr),"Signing"]= summarySigningData[NS,nAttr]
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("IssuanceVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("IssuanceVaryNS.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZKpresentVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("ZKpresentVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Issuane time comparison BLS461-BLS381 for",parseToNumber(nAttr),"attributes"),x="Number of signers", y="Time (ms)")+
  theme_ipsum_rc()
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Issuane time comparison BLS461-BN254 for",parseToNumber(nAttr),"attributes"),x="Number of signers", y="Time (ms)")+
  theme_ipsum_rc()
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("CurveIssuanceVarAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Issuane comparison BLS461-BLS381-BN254 for 5 attributes"),x="Number of signers", y="Time (ms)")+
  theme_ipsum_rc()
# ggsave("CurveIssuanceVarNS.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("CurveZkProofVarRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Zk proof BLS461-BLS381-BN254 for 2 revealed attributes"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
# ggsave("CurveZkProofVarAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("CurveZkVerfVarRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Zk verification BLS461-BLS381-BN254 2 revealed attributes"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
ggsave("CurveZkVerfVarAttr.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("IdemixIssuancePlot.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotRows(summaryzkProofDataIdemix,"Idemix Zk proof generation","Number of revealed attributes","Time (ms)","Attributes","NoAttr")
# ggsave("IdemixZkProof.pdf", device = cairo_pdf)
show(g)
```
...
# ggsave("IdemixZkVerf.pdf", device = cairo_pdf)
show(g)
```
...
g<-multilinePlotRows(summaryzkVerifyDataIdemix,"Idemix ZK proof verification","Number of revealed attributes","Time (ms)","Attributes","NoAttr")
show(g)
```
...
for(nAttr in numberOfAttributes){
  df[parseToNumber(nAttr),"PS"]= summaryIssuanceData[NS,nAttr]
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Issuance comparison using 2 signers"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
# ggsave("IdemixIssuance2NS.pdf", device = cairo_pdf)
show(g)
```
...
Using 10 signers for PS
```{r varyIssuanceDataComparison10,echo=FALSE,include=FALSE}
NS<-"10"
numberOfAttributes<-c("NoAttr-02","NoAttr-04","NoAttr-06","NoAttr-08")
df<-data.frame(matrix(nrow =length(numberOfAttributes) ,  ncol=2))
rownames(df)<-lapply(numberOfAttributes,parseToNumber)
...
```{r varyIssuanceBarsComparison10, echo=FALSE, fig.cap="Time comparison between PS and Idemix Issuance for multiple number of attributes",fig.align='center', out.width='.5\\linewidth', warning=FALSE}
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Issuance comparison using 10 signers"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
# ggsave("IdemixIssuance10NS.pdf", device = cairo_pdf)
show(g)
```

```{r varyIssuanceStackedBarsComparison10, echo=FALSE, fig.cap="Time comparison between PS and Idemix Issuance for multiple number of attributes",fig.align='center', out.width='.5\\linewidth', warning=FALSE,include=FALSE,eval=FALSE}
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) +
  geom_bar(position="stack", stat="identity")+
  labs(fill="Step",title = paste("Time comparison for",NS,"signers"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("IdemixZkProofCompVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Zk proof comparison for 2 revealed attributes"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
# ggsave("IdemixZkProofCompVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  ...
  theme_ipsum_rc()
# ggsave("IdemixZkVerfCompVaryRevAttr.pdf", device = cairo_pdf)
show(g)
```
...
g<-ggplot(meltedDF,aes(fill=variable, y=value, x=group)) + 
  geom_bar(position="dodge", stat="identity")+
  labs(fill="Step",title = paste("Zk verification comparison for 2 revealed attributes"),x="Number of attributes", y="Time (ms)")+
  theme_ipsum_rc()
ggsave("IdemixZkVerfCompVaryAttr.pdf", device = cairo_pdf)
show(g)
```
...
```{r statSignificanceIssuaneBLS461Idemix, echo=FALSE}
NS<-10
NAttr<-2
numberOfPermutations<-1000
data1<-signingData[[9]]$`NoAttr-02`+combineData[[9]]$`NoAttr-02`+verifyData[[9]]$`NoAttr-02`
name1<-"BLS461"
data2<-idemixIssuance[[1]]$`NoAttr-02`
name2<-"Idemix"
data<-c(data1,data2)
...
```{r statSignificanceIssuane2BLS461Idemix, echo=FALSE}
...
```{r statSignificanceIssuaneBLS461BLS381BN254, echo=FALSE}
NS<-10
NAttr<-5
numberOfPermutations<-1000
data1<-signingDataBN254[[9]]$`NoAttr-05`+combineDataBN254[[9]]$`NoAttr-05`+verifyDataBN254[[9]]$`NoAttr-05`
name1<-"BN254"
data2<-signingDataBLS381[[9]]$`NoAttr-05`+combineDataBLS381[[9]]$`NoAttr-05`+verifyDataBLS381[[9]]$`NoAttr-05`
name2<-"BLS381"
data3<-signingData[[9]]$`NoAttr-05`+combineData[[9]]$`NoAttr-05`+verifyData[[9]]$`NoAttr-05`
name3<-"BLS461"
...
```{r statSignificanceIssuane2BLS461BLS381BN254, echo=FALSE}
#shapiro.test(permStat)
ajuste<-fitdist(permStat,"norm")
mu<-ajuste$estimate[1]
sigma<-ajuste$estimate[2]
