...
public class Hash1BLS381 implements Hash1 {
    ...
    private ZpElement hashVK(PSverfKey vk) {
        if(!(vk.getVX() instanceof Group2ElementBLS381))
        ...
        Group2ElementBLS381 x=(Group2ElementBLS381)vk.getVX();
        Group2ElementBLS381 y_m=(Group2ElementBLS381)vk.getVY_m();
        Group2ElementBLS381 y_epoch=(Group2ElementBLS381)vk.getVY_epoch();
