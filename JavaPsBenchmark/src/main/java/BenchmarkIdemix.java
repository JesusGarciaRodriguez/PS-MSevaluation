...
public class BenchmarkIdemix {
    ...
    private static List<Long> benchZK(int numberOfRevealedAttr,ListOfSignaturesAndAttributes sigAndAttr,PublicKey pk,BigInt credSpecId, SystemParameters systemParameters, SignatureBuildingBlock clSignatureBuildingBlock, RevealAttributeBuildingBlock revealBB, ZkDirector zkDirector, Injector injector) throws ProofException, ConfigurationException, URISyntaxException {
        RangeProofBuildingBlock rangeBB=injector.getInstance(FourSquaresRangeProofBuildingBlock.class);
        PseudonymBuildingBlock pseudoBB=injector.getInstance(ScopeExclusivePseudonymBuildingBlock.class);
        URI deviceUri=new URI("urn:device");
