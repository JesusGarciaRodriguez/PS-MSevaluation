...
public class TestBLS381 {
    ...
    public void testHash0(){
        ...
        for(int i=0;i< tamMessage;i++){
            m1.add(new ZpElementBLS381(BIG.randomnum(p, rng)));
        }
        for(int i=0;i< tamMessage;i++){
            m2.add(new ZpElementBLS381(BIG.randomnum(p, rng)));
        }
        //Hashing
...
//Create a PS-scheme instantiation
    ...
    public void testHash2() throws MSSetupException {
        ...
        PairingBuilder builder=new PairingBuilderBLS381();
        PairingBLS381 pair=new PairingBLS381();
    ...
    public void testArgumentExceptionsGroup1Element(){
        Group1Element g=(new PairingBuilderBLS381()).getGroup1Generator();
    ...
    public void testArgumentExceptionsGroup2Element(){
        Group2Element g=(new PairingBuilderBLS381()).getGroup2Generator();
    ...
    public void testArgumentExceptionsGroup3Element(){
        Group3Element g=(new PairingBuilderBLS381()).getGroup3Generator();
    ...
    public void testArgumentExceptionsZpElement(){
        ZpElement z=(new PairingBuilderBLS381()).getRandomZpElement();
        ZpElement mockZ=new ZpElementMock();
        try{
            z.add(mockZ);
    ...
    public void testArgumentExceptionsHash0(){
        Hash0 h=(new PairingBuilderBLS381()).getHash0();
    ...
    public void testArgumentExceptionsHash1(){
        Hash1 h=(new PairingBuilderBLS381()).getHash1();
        Group2Element mockG=new Group2ElementMock();
    ...
    public void testArgumentExceptionsHash2(){
        Hash2 h=(new PairingBuilderBLS381()).getHash2();
        Group1Element g1=(new PairingBuilderBLS381()).getGroup1Generator();
        Group1Element mockG1=new Group1ElementMock();
        Group1Element g2=(new PairingBuilderBLS381()).getGroup1Generator();
        Group1Element mockG2=new Group1ElementMock();
        Group3Element g3=(new PairingBuilderBLS381()).getGroup3Generator();
    ...
    public void testArgumentExceptionsPair(){
        Pairing pairing=(new PairingBuilderBLS381()).getPairing();
        Group1Element g1=(new PairingBuilderBLS381()).getGroup1Generator();
        Group1Element mockG1=new Group1ElementMock();
        Group2Element g2=(new PairingBuilderBLS381()).getGroup2Generator();
